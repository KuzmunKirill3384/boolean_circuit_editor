"""
Тесты для основного класса модели backend.model.circuit.Circuit.

Проверяются ключевые операции:
  - Добавление узлов с проверкой поддерживаемых типов
  - Соединение пинов (валидация, запрет множественных подключений к одному входу)
  - Обнаружение циклов
  - Удаление узлов и автоматическое удаление связанных связей
