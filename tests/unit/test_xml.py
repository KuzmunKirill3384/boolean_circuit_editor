"""
Тесты для модуля backend.io.xml_builder.

Проверяется корректность сериализации и десериализации схем:
  - Полный roundtrip (export → import) с сохранением узлов, координат и связей
  - Сохранение и восстановление id узлов
  - Обработка простых и пустых схем
"""
